...
//usage access permission class used in different screens

public class PermissionClass {
    public static void checkPermission(final Activity activity){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if (UStats.getUsageStatsList(activity).isEmpty()){
    ...
    static void showUsageDialog(final Activity activity) {
